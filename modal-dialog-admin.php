...
class modal_dialog_plugin_admin {
	...
	function on_admin_menu() {
		...
		$this->pagehooktop      = add_menu_page( __( 'Modal Dialog General Options', 'modal-dialog' ), "Simple pop up", $accesslevelcheck, MODAL_DIALOG_ADMIN_PAGE_NAME, array(
			$this,
			'on_show_page'
	...
	function on_show_page() {
		...
		if ( $_GET['page'] == 'modal-dialog' ) {
			$pagetitle = __( 'Simple pop up General Settings', 'modal-dialog' );
			...
			$pagetitle = __( 'Simple pop up Configurations', 'modal-dialog' );
